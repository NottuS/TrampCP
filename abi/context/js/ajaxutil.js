    ...
    xmlhttp.onreadystatechange=function() {
        if (xmlhttp.readyState==4){
            ...
            if(retorno.indexOf('<login>')!=-1){
            	...
            	window.location	= "\posLoginUsuario.do"; 
            }else{
...
function submitAjax(url, formName, tagUrl, mostraCarregando, limpaMsg) {
	...
	if(mostraCarregando){
		$(tagUrl).innerHTML='<h1><img src=images/icon_ajuda.gif> Carregando ...</h1>' + $(tagUrl).innerHTML;
	}
	tagGeral = tagUrl;	
	limparMsg = limpaMsg;	
...
/****************************************************************************
 * Inicio das fun̵̤es customizadas CELEPAR
...
function openAjax(url, tagUrl, mostraCarregando, limpaMsg) {
	...
	url = escape(url);
	if(mostraCarregando){
		$(tagUrl).innerHTML='<h3><img src=images/icon_loading.gif> Carregando ...</h3>' + $(tagUrl).innerHTML;
	}
	tagGeral = tagUrl;
	limparMsg = limpaMsg;
...
/****************************************************************************
 * Fun̤̣o responsavel por tratar a mensagem de erro e coloca-la no padṛo do Framework
