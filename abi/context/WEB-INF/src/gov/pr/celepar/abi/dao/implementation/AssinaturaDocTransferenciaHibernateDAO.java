 ...
 *
 */
public class AssinaturaDocTransferenciaHibernateDAO extends GenericHibernateDAO<AssinaturaDocTransferencia, Integer> implements AssinaturaDocTransferenciaDAO {

	private static Logger log4j = Logger.getLogger(AssinaturaDocTransferenciaHibernateDAO.class);
	...
	public Collection<AssinaturaDocTransferencia> listar(Integer codTransferencia) throws ApplicationException {
		try {
			...
			hql.append(" FROM AssinaturaDocTransferencia a ")
	...
	public Collection<AssinaturaDocTransferencia> listaVerificacao(AssinaturaDocTransferencia assinatura) throws ApplicationException {
		try {
			...
			Query q = session.createQuery(hql.toString());
			q.setInteger("codTransferencia", assinatura.getTransferencia().getCodTransferencia());
