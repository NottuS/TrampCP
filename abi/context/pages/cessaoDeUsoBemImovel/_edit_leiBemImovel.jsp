...
<html:hidden property="codLei" value="${cessaoDeUsoBemImovelForm.codLei}"/>
<h2>Dados da Lei</h2>
<table width="100%">
 	<tr>
 		<td class="form_label" width="260">Projeto de Lei: </td>
 		<td>
			<html:radio value="S" property="projetoLei" name="cessaoDeUsoBemImovelForm" styleId="projetoLeiS" onclick="javascript:atribuirFocoNrLei();">Sim</html:radio>
			<html:radio value="N" property="projetoLei" name="cessaoDeUsoBemImovelForm" styleId="projetoLeiN" onclick="javascript:atribuirFocoNrLei();">Não</html:radio>
		</td>
	</tr>
	<tr>
		...
		<td> 
			<table>
				<tr>
					<td>
						<html:text property="numeroLei" name="cessaoDeUsoBemImovelForm" styleId="numeroLei" maxlength="10" size="10" onkeyup="DigitaNumero(this);" onblur="buscaLeiBemImovel();atribuirFocoNrLei();" />
					</td>
					<td>
	...
	<tr> 
        ...
        <td>
			<html:text styleId="dataAssinaturaLei" property="dataAssinaturaLei" name="cessaoDeUsoBemImovelForm" size="10" maxlength="10" onkeyup="javascript:return(MascaraData(this,event));"/>
	...
	<tr> 
        ...
        <td>
			<html:text styleId="dataPublicacaoLei" property="dataPublicacaoLei" name="cessaoDeUsoBemImovelForm" size="10" maxlength="10" onkeyup="javascript:return(MascaraData(this,event));" />
	...
	<tr>
		...
		<td> 
			<html:text property="nrDioeLei" name="cessaoDeUsoBemImovelForm" styleId="nrDioeLei" maxlength="15" size="15" onkeyup="DigitaNumero(this);"/>
		</td>
	</tr>
</table>
