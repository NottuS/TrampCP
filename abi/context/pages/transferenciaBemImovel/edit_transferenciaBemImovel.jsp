...
<script language="javascript">
	...
	function validarCamposItemTransferencia() {
		if(validarCampos()) {
			...
			if(!document.getElementById("tipoTransferencia1").checked && !document.getElementById("tipoTransferencia2").checked
				...
				erro = erro + '- \"Tipo de Transferência\".';
			}
			...
			if((document.getElementById("tipoTransferencia2").checked || document.getElementById("tipoTransferencia3").checked) 
				...
				erro = erro + '- \"Transferência em m² ou Transferência em %\".';
			} 
	...
	function calcularTransferencia() {
		...
		if (form.nrBemImovel.value.length > 0) {
			if (form.nrBemImovel.value != '' && form.nrBemImovel.value > 0 && form.instituicao.value != '' && form.instituicao.value > 0){
				alert("Para efetuar o cálculo a Transferência em m² ou a Transferência em % deverá ser preenchida!");
	...
	function validarCamposDesnecPreenchidos() {
		...
		if(document.getElementById("tipoTransferencia1").checked || document.getElementById("tipoTransferencia2").checked
			...
			alert("Foram detectados campos preenchidos na seção 'Item de Transferência', favor adicioná-lo ou limpar os campos preenchidos!");
			return false;
		}
				...
				<tr>
					<td colspan="2" width="100%">
					    <div id="divItemTransferencia"> 
							<h2>Item da Transferência</h2>
							<table width="100%">
								<tr>
								 	<td class="form_label" width="260">Tipo de Transferência: </td>
							 		<td>
										<html:radio name="transferenciaBemImovelForm" value="1" property="tipoTransferencia" styleId ="tipoTransferencia1" onchange="javascript:habilitarDesabilitarCamposTransferencia();">Total do Bem Imóvel</html:radio>
										<html:radio name="transferenciaBemImovelForm" value="2" property="tipoTransferencia" styleId ="tipoTransferencia2" onchange="javascript:habilitarDesabilitarCamposTransferencia();">Edificação</html:radio>
