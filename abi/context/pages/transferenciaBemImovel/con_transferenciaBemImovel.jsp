...
<script language="javascript">
	...
	function alterar(id, status) {
		if (status == 1) {
			if(confirm('Confirma a finalização desta Transferência e geração de uma nova Transferência com base nestas informações?')) {
...
<div id="conteudo">
	<div align="center">
	<h1> Transferência de Uso de Bem Imóvel </h1>
			...
			<c:if test="${!empty pagina && pagina.totalRegistros > 0}">
				<div id="conteudo_corpo">    
					...
					<ch:table classTable="list_tabela" classLinha1="list_cor_sim" classLinha2="list_cor_nao">
						...
						<ch:campo atributo="orgaoCessionario.siglaDescricao" label="Órgão de Destino" align="left"/>
						<ch:campo atributo="dtInicioVigencia" label="Data da Transferência" align="left" decorator="gov.pr.celepar.framework.taglib.grid.decorator.Data" />
